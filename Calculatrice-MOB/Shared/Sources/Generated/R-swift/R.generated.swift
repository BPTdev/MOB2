...
struct R: Rswift.Validatable {
	...
	struct color {
		/// Color `buttonTextHighlight`.
		static let buttonTextHighlight = Rswift.ColorResource(bundle: R.hostingBundle, name: "buttonTextHighlight")
		/// Color `buttonText`.
		...
		/// Color `scene2Background`.
		static let scene2Background = Rswift.ColorResource(bundle: R.hostingBundle, name: "scene2Background")
		/// Color `separator`.
		...
		#if os(iOS) || os(tvOS)
			/// `UIColor(named: "buttonTextHighlight", bundle: ..., traitCollection: ...)`
			@available(tvOS 11.0, *)
			@available(iOS 11.0, *)
			static func buttonTextHighlight(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIColor? {
				return UIKit.UIColor(resource: R.color.buttonTextHighlight, compatibleWith: traitCollection)
			}
		#endif
		...
		#if os(iOS) || os(tvOS)
			/// `UIColor(named: "scene2Background", bundle: ..., traitCollection: ...)`
			@available(tvOS 11.0, *)
			@available(iOS 11.0, *)
			static func scene2Background(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIColor? {
				return UIKit.UIColor(resource: R.color.scene2Background, compatibleWith: traitCollection)
			}
		#endif
